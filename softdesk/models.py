...
class Contributors(models.Model):
    ...
    project_id = models.ForeignKey(Projects, on_delete=models.CASCADE, related_name='projects_contributors')
...
class Issues(models.Model):
    ...
    title = models.CharField(max_length=255)
    author_user_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    project_id = models.ForeignKey(Projects, on_delete=models.CASCADE, related_name='projects_issues')
